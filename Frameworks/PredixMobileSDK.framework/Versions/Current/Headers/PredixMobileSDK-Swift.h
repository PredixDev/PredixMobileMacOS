...
@interface PredixMobilityManager : NSObject <NSUserNotificationCenterDelegate>
...
- (void)applicationWillResignActive:(NSApplication * _Nonnull)application;
- (void)applicationDidBecomeActive:(NSApplication * _Nonnull)application;
- (void)applicationWillTerminate:(NSApplication * _Nonnull)application;
- (void)application:(NSApplication * _Nonnull)application didReceiveRemoteNotification:(NSDictionary * _Nonnull)userInfo;
